...
#define Comp_AMPEXP 9
#define DC_OFFSET (-7*(1<<Comp_AMPEXP))
#define Comp_AMP1 (18*(1<<Comp_AMPEXP))
#define Comp_AMP2 (14*(1<<Comp_AMPEXP))
#define Comp_AMP3 (3*(1<<Comp_AMPEXP))
#define Comp_AMP4 (6*(1<<Comp_AMPEXP))
...
#define Comp_ALPHA1 (130)
#define Comp_ALPHA2 (0)
